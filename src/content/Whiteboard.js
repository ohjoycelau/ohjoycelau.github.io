		...
		<div>
			<main className="font-body">
				...
				<section className="section-default pt-8">
					...
					<h2 className="my-8">Artists come by and perform at Pandora's HQ. Unique whiteboard illustrations backdrop each artist.</h2>
					<h3>Process</h3>
					<p>The Whiteboard is an unusual and finicky medium. The whiteboard marker is misleading – it's opaqueness decieves its delicate permanence. Despite challenges, I have come to love it for its temporal and tempermental qualities and I continue to discover new marks this medium has to offer.</p>
				...
				<section className="section-full">
					...
					<img className="my-8" src={require("./images/wbs/1-wbs.jpg")} alt="Whiteboard - Aurora" />
					<img className="my-8" src={require("./images/wbs/2-wbs.jpg")} alt="Whiteboard - Holly Miranda" />
					<img className="my-8" src={require("./images/wbs/3-wbs.jpg")} alt="Whiteboard - Highly Suspect" />
					<img className="my-8" src={require("./images/wbs/4-wbs.jpg")} alt="Whiteboard - Highly Suspect" />
					<img className="my-8" src={require("./images/wbs/5-wbs.jpg")} alt="Whiteboard - Wild Child" />
					<img className="my-8" src={require("./images/wbs/6-wbs.jpg")} alt="Whiteboard - Moon Taxi" />
				</section>


				<section className="section-default mb-8">
					<p>I like to make and draw on other things too. Sometimes I take pictures.</p>
					<p><a target="blank" href="http://instagram.com/ohjoycelau">See more on Instagram</a></p>
				</section>


				<section className="section-default flex-between pt-8 pb-12">
					<h3><Link to="/Pandora-Systems">Previous Project</Link></h3>
