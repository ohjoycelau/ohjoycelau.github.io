...
function Annenberg() {
	return (
		<div>
			...
			<div className="section--full img--90" id="annenberg--menu">
			...
			<div className="section--full img--90" id="annenberg--calendar">
				<img src={require("./images/annenberg/annenberg-calendar.png")} />
			</div>
			<div className="section--full img--90" id="annenberg--event">
				<img src={require("./images/annenberg/annenberg-event-browser.png")} />
			</div>
			<div className="section--center">
				<ul className="group--button flex">
					<li><Link className="button button--prev" to="/" >Back Home</Link></li>
					<li><Link className="button button--next" to="/Pandora-Blog" >Next Project</Link></li>
				</ul>
			</div>
		</div>
	)
